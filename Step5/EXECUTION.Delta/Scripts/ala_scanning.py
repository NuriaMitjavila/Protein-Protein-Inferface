...
print("Total energy of all residues: ", Telec + Tvdw + Tsolvation - TsubunitA - TsubunitF)
...
for residues in get_interface(st, 7)["A"]:
...
print("Total energy of interface residues: ", Ielec + Ivdw + Isolvation - IsubunitA - IsubunitF)
...
f.write(str(Telec + Tvdw + Tsolvation - TsubunitA - TsubunitF))
f.write("\nTotal energy of interface residues, alanine scanning: ")
f.write(str(Ielec + Ivdw + Isolvation - IsubunitA - IsubunitF))
