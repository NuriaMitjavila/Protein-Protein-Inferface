...
args['input_structure_path'] = base_path + '7v8b.pdb'
args['output_structure_path'] = base_path + '7v8b_fixed.pdb'
args['output_structure_path_charges'] = base_path + '7v8b_fixed.pdbqt'
args['debug'] = False
args['verbose'] = False
