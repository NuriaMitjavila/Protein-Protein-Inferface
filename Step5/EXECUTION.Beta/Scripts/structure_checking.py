...
args['input_structure_path'] = base_path + '8df5.pdb'
args['output_structure_path'] = base_path + '8df5_fixed.pdb'
args['output_structure_path_charges'] = base_path + '8df5_fixed.pdbqt'
args['debug'] = False
args['verbose'] = False
