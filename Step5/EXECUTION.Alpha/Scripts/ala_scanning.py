...
for residues in chainB.get_residues():
    Telec += calc_int_energies(st[0], residues)[0]
    Tvdw += calc_int_energies(st[0], residues)[1]
    Tsolvation += calc_solvation(residues)
    TsubunitB += calc_solvation(st[0][chainB.id][residues.id[1]])
    diccionari[residues.id[1]] = calc_int_energies(st[0], residues)[0]+calc_int_energies(st[0], residues)[1]+calc_solvation(residues)-calc_solvation(st[0][chainB.id][residues.id[1]])

print("Total energy of all residues: ", Telec + Tvdw + Tsolvation - TsubunitA - TsubunitB)
...
for residues in get_interface(st, 7)["B"]:
    Ielec += calc_int_energies(st[0], residues)[0]
    Ivdw += calc_int_energies(st[0], residues)[1]
    Isolvation += calc_solvation(residues)
    IsubunitB += calc_solvation(st[0][chainB.id][residues.id[1]])

print("Total energy of interface residues: ", Ielec + Ivdw + Isolvation - IsubunitA - IsubunitB)
...
f.write(str(Telec + Tvdw + Tsolvation - TsubunitA - TsubunitB))
f.write("\nTotal energy of interface residues, alanine scanning: ")
f.write(str(Ielec + Ivdw + Isolvation - IsubunitA - IsubunitB))
